...
def run_cplex(
        ...
        mip_gap: float = 0.05, num_threads: int | None = os_threads,
        mps_lp_convert: bool = True, debug: bool = False) -> None:
    ...
    scipy.io.savemat(
        cplex_result, {"x": x_optim, "obj": objective, "time": wallclock_time})
