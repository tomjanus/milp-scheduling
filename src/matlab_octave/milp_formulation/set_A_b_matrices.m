function [A, b] = set_A_b_matrices(vars, linprog, lin_power, lin_pipes, ...
  ...
  [A_ss_box, b_ss_box] = ss_box_constraints(vars, pump_groups, linprog);
  [A_qq_box, b_qq_box] = qq_box_constraints(vars, pump_groups, linprog);
  ...
  A = [A_p; A_p_lin; A_pipe; ... %A_s_box; A_q_box; 
    A_ss_box; A_qq_box; A_pumpeq; A_pump_domain; A_pumpsymmetry];
  b = [b_p; b_p_lin; b_pipe; ... %b_s_box; b_q_box; 
    b_ss_box; b_qq_box; b_pumpeq; b_pump_domain; b_pumpsymmetry];
